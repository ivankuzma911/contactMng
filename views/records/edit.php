...
<form action="" method="POST">
    ...
    <table>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="first" id="first" maxlength="30" size="15"  value="<?php if(isset($result['email'])){echo $result['first'];}else{ echo $prev_values['prev_values']['first'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="last" id="last" maxlength="30" size="15"  value="<?php if(isset($result['email'])){echo $result['last'];}else{echo $prev_values['prev_values']['last'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" id="home"  name="home" maxlength="30" size="15" value="<?php if(isset($result['email'])){echo $result['home'];}else{echo $prev_values['prev_values']['home'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input id="work" type="text" name="work" maxlength="30" size="15" value="<?php if(isset($result['email'])){echo $result['work'];}else{echo $prev_values['prev_values']['work'];} ?>">
            </td>
            <?php if(isset($errors['errors']['work'])):?>
                <td class="warning" title="At least 6 symbols"><?=$errors['errors']['work']?></td>
            <?php endif;?>
        </tr>
        <tr>
            <td>
            ...
            <td align="right">
                <input type="text" id="cell" name="cell" maxlength="30" size="15" value="<?php if(isset($result['email'])){echo $result['cell'];}else{echo $prev_values['prev_values']['cell'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="address1" maxlength="30" id="address1" size="15" value="<?php if(isset($result['email'])){echo $result['address1'];}else{echo $prev_values['prev_values']['address1'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="address2" maxlength="30" id="address2" size="15" value="<?php if(isset($result['email'])){echo $result['address2'];}else{echo $prev_values['prev_values']['address2'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="city" maxlength="30" size="15" id="city" value="<?php if(isset($result['email'])){echo $result['city'];}else{echo $prev_values['prev_values']['city'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="state" maxlength="30" id="state" size="15" value="<?php if(isset($result['email'])){echo $result['state'];}else{echo $prev_values['prev_values']['state'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="zip" maxlength="30" size="15" id="zip" value="<?php if(isset($result['email'])){echo $result['zip'];}else{echo $prev_values['prev_values']['zip'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="country" maxlength="30" id="country" size="15" value="<?php if(isset($result['email'])){echo $result['country'];}else{echo $prev_values['prev_values']['country'];} ?>">
            </td>
        ...
        <tr>
            ...
            <td align="right">
                <input type="text" name="birthday" maxlength="30" id="birthday" size="15" value="<?php if(isset($result['email'])){echo $result['birthday'];}else{echo $prev_values['prev_values']['birthday'];} ?>">
            </td>
